...
@section("content")
    <div class="w-full max-w-4xl p-6 bg-white rounded-lg shadow-md mx-auto">
        <h1 class="text-3xl font-semibold text-[#333333] mb-5">Semua Pengguna</h1>
            ...
            <table class="min-w-full bg-white border border-gray-300 rounded-lg shadow-md">
                ...
                <tbody class="overflow-y-scroll">
                    @foreach($users as $user)
                        <tr class="border-b hover:bg-gray-100 cursor-pointer" data-href="{{ route('users.show', $user->id) }}">
